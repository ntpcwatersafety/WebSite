...
- 本機內容會直接讀取 public/cms-data.json
...
- REPO = WebSite
- BRANCH = main
- DATA_PATH = public/cms-data.json
- JWT_EXPIRES_IN = 8h
...
3. 再測 ntpcwsa.org/api/cms，確認可從 GitHub 讀取 cms-data.json
...
- ntpcwsa.org/api/cms 應回傳 cms-data.json 內容
...
- ntpcwsa.org/api/cms 可正常讀取 GitHub 上的 cms-data.json
